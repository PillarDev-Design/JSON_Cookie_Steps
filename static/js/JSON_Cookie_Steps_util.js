/******************************************************************************\
 * JSON_Cookie_Steps_Util.js                                                  *
 * -------------------------------------------------------------------------- *
 *      This js file is a compilation of code designed from various authors   *
 * to allow the developer to easily access the specific cookie information in *
 * a document. It will allow the developer to write, access, and manipulate   *
 * in JSON format.                                                            *
\******************************************************************************/
